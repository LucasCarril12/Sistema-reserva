...
class ReservationFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return[
            ...
            //TO DO: Borrar estos 2 campos ya que no son necesarios
            'payment_status' => $this->faker->randomElement(['pendiente','pago','fallido']),
            //'total_amount' => $this->faker->randomFloat(50),
        ];
    }
