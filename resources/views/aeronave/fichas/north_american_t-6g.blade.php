    ...
    <div class="layout-wrapper landing bg-welcome-color">
        ...
        <section class="section-museo py-5">
            <div class="container">
                ...
                <h1 class="museo-title">North American T-6G</h1>
                <h5 class="museo-subtitle">“Texan”</h5>
                </div>

                <div class="row g-4 mb-5">
                <div class="col-md-6">
                    <img src="{{ asset('assets/images/aeronaves/img-fichas/north american t-6/at-61.jpg') }}" class="img-fluid museo-img" alt="Farman 50hp - Imagen 1">
                </div>
                <div class="col-md-6">
                    <img src="{{ asset('assets/images/aeronaves/img-fichas/north american t-6/at-62.jpg') }}" class="img-fluid museo-img" alt="Farman 50hp - Imagen 2">
                </div>
                </div>
                ...
                <div class="col-lg-6 museo-text">
                    <p>
                        <strong><strong>Fabricante:</strong></strong> North American Aviation Inc. (EE.UU.) <br>
                        <strong><strong>Tipo:</strong></strong> Entrenador avanzado <br>
                        <strong><strong>Descripción:</strong></strong> Monomotor biplaza en tándem, metálico de ala baja y tren convencional retráctil <br>
                        ...
                        <strong><strong>En exhibición:</strong></strong>T6-G FAU 373 s/n 51-14775, Grupo de Aviación Nº1, Base Aérea Nº2, Durazno c.1970 <br>
                    </p>
                </div>

                <div class="col-lg-6 museo-text">
                    <p>
                        <strong><strong>Manufacturer:</strong></strong> North American Aviation Inc. (EE.UU.) <br>
                        <strong><strong>type:</strong></strong> Advanced trainer <br>
                        <strong><strong>Description:</strong></strong> Single-engine, low wing metallic aircraft, with a tandem two-place cockpit and a retractable undercarriage <br>
                        <strong><strong>Power plant:</strong></strong>  Pratt & Whitney R-1340-AN-1 Wasp, radial 600hp <br>
                        <strong><strong>Performance:</strong></strong> Max. speed 212 mph - Max. ceiling 24,200 ft - Range 870 miles<br>
                        <strong><strong>Armament (optional):</strong></strong> .30 mg in the right wing, rear cockpit, and front capot in models “B” and “C”, bombs and rockets<br>
                        <strong><strong>In Uruguay:</strong></strong> Military Aeronautics / Uruguayan Air Force, 1942 - 1993 (48 units). Naval Aviation, 1950 - 1984 (11 units of the SNJ model) <br>
                        <strong><strong>In exhibicion:</strong></strong> T6-G FAU 373 s/n 51-14775, Aviation Group Nº1, Air Base Nº2, Durazno c.1970<br>
                    </p>
                </div>
                </div>

                <div class="text-center mt-4">
                <a href="{{ asset('assets/images/aeronaves/fichas_aeronaves/North American T-6G_Texan__.png') }}" class="btn btn-museo me-2" download="North American T-6G - Ficha">Descargar ficha</a>
