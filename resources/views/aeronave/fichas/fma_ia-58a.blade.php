    ...
    <div class="layout-wrapper landing bg-welcome-color">
        ...
        <section class="section-museo py-5">
            <div class="container">
                ...
                <h1 class="museo-title">FMA IA-58A</h1>
                <h5 class="museo-subtitle">“Pucará”</h5>
                </div>

                <div class="row g-4 mb-5">
                <div class="col-md-6">
                    <img src="{{ asset('assets/images/aeronaves/img-fichas/fma/fma.jpg') }}" class="img-fluid museo-img" alt="FMA IA-58A - Imagen 1">
                </div>
                <div class="col-md-6">
                    <img src="{{ asset('assets/images/aeronaves/img-fichas/fma/fma-1.jpg') }}" class="img-fluid museo-img" alt="FMA IA-58A - Imagen 2">
                </div>
                </div>
                ...
                <a href="{{ asset('assets/images/aeronaves/fichas_aeronaves/FMA IA-58A_Pucará_-28') }}" class="btn btn-museo me-2" download="FMA IA-58A Pucará - Ficha">Descargar ficha</a>
