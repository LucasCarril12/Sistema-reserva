    ...
    <div class="layout-wrapper landing bg-welcome-color">
        ...
        <section class="section-museo py-5">
            <div class="container">
                ...
                <h1 class="museo-title">DOUGLAS DC-3/C-47</h1>
                <h5 class="museo-subtitle">"Skytrain"</h5>
                </div>

                <div class="row g-4 mb-5">
                <div class="col-md-6">
                    <img src="{{ asset('assets/images/aeronaves/img-fichas/dc-3-c-47/dc-3-c-47.png') }}" class="img-fluid museo-img" alt="Douglas DC-3/C-47 - Imagen 1">
                </div>
                <div class="col-md-6">
                    <img src="{{ asset('assets/images/aeronaves/img-fichas/dc-3-c-47/dc-3-c-47-2.jpg') }}" class="img-fluid museo-img" alt="Douglas DC-3/C-47 - Imagen 2">
                </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6 museo-text">
                        <p>
                            ...
                            <strong>En Uruguay:</strong> Aeronáutica Militar / Fuerza Aérea Uruguaya, 1947–1988 (22 unidades). PLUNA – Primeras Líneas Uruguayas de Navegación Aérea, 1946–1971 (8 aeronaves, solo una fue DC-3 original) <br>
                ...
                <a href="{{ asset('assets/images/aeronaves/fichas_aeronaves/Douglas DC-3_C-47_Skytrain_-17.png') }}" class="btn btn-museo me-2" download="Douglas DC-3/C-47 - Ficha">Descargar ficha</a>
